...
data5 = [row[5] for row in data]
data6 = [row[6] for row in data]
data7 = [row[7] for row in data]
...
lp.data = [list(zip(times, pred)),
           list(zip(times, high)),
           list(zip(times, low)),           
           list(zip(times, data5)),
           list(zip(times, data6)),
           list(zip(times, data7))]
...
lp.lines[4].strokeColor = colors.purple
lp.lines[5].strokeColor = colors.orange

#
# red, white, black, green, yellow, blue, purple, grey, brown, pink, gold, orange
#
